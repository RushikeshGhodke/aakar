    ...
    const navItems = [
        {
            ...
            icon: "FiClipboard",
            children: [
                { name: "Employees", slug: "/employees", icon: "FiUser", access: HRManagementAccess[2] },
                { name: "Departments", slug: "/departments", icon: "FiBriefcase", access: HRManagementAccess[6] },
                { name: "Designations", slug: "/designations", icon: "PiOfficeChair", access: HRManagementAccess[10], },
            ],
        },
        {
            ...
            children: [
                { name: "Create Ticket", slug: "/create-ticket", icon: "BsTicket", access: TicketManagementAccess[2] },
                { name: "View Tickets", slug: "/view-tickets", icon: "BsTicket", access: TicketManagementAccess[6] },
            ],
        },
        {
            name: "Training",
            ...
            children: [
                { name: "Employee Status", slug: "/EmployeeSwitch", icon: "FaUserAlt", access: TicketManagementAccess[2] },
                { name: "Skills", slug: "/Update_skills", icon: "GiSkills", access: TicketManagementAccess[2] },
                { name: "Skill Matrix", slug: "/SearchBar", icon: "IoIosGrid", access: TicketManagementAccess[2] },
                { name: "Assign Training", slug: "/SendAndGiveTraining", icon: "FaChalkboardTeacher", access: TicketManagementAccess[2] },
                { name: "Training Plan", slug: "/trainings", icon: "MdBook", access: TicketManagementAccess[2] },
                { name: "Trainer Status", slug: "/TrainerSwitch", icon: "AiOutlineCheckCircle", access: TicketManagementAccess[2] },
            ],
        },
    ];
    ...
    return (
        <div className="sidebar" onMouseLeave={closeSubmenus}>
            <div>
                ...
                <div className="menu">
                    {navItems.map((item) => (
                        (item.access === '1' && <div key={item.name}>
                            <div
