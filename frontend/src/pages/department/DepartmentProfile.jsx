...
function DepartmentProfile() {
    ...
    function getDepartmentById(departmentId) {
        return workingDepartments.find(department => department.departmentId === departmentId);
    }
            ...
            <div className="add-employee-dashboard">
                <section className="add-employee-head flex justify-between mb-3">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        >
                            <h2 className="text-xl font-semibold mb-4">What to do with current employees?</h2>

                            <div className="employee-list space-y-2">
                                {filteredEmployees.map((employee) => (
                                    <div key={employee.employee.customEmployeeId} className="flex items-center gap-2">
                                        <input
                                            type="checkbox"
                                            id={employee.employee.customEmployeeId}
                                            onChange={() => handleCheckboxChange(employee?.employee?.employeeId)}
                                            className="w-4 h-4"
                                        />
                                        <label htmlFor={employee.employee.customEmployeeId} className="text-gray-800">
                        ...
                        <Modal
                            ...
                            overlayClassName="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center"
                        >
                            <h2 className="text-xl font-semibold mb-4">Select a Department</h2>
                                ...
                                {filteredDepartments.map((dept) => (
                                    <div key={dept.departmentId} className="flex items-center gap-2">
                                        <input
                                            ...
                                            className="w-4 h-4"
                                        />
                                        <label htmlFor={`dept-${dept.departmentId}`} className="text-gray-800">
                                            {dept.departmentName}
                                        </label>
                                    </div>
                                ))}
                ...
                <section className="add-employee-body bg-white px-10 py-7 rounded">
                    ...
                    <div
                        ...
                        <div className="flex flex-col w-max">
                            ...
                            <span className="text-black text-lg font-semibold">{department.departmentName}</span>
                        </div>
                        <div className="flex flex-col w-max">
                            <span className="text-[#585858] text-[16px]">Start Date</span>
                            <span className="text-black text-lg font-semibold">
                                {department.departmentStartDate ? moment(department.departmentStartDate).format('DD/MM/YYYY') : 'N/A'}
                            </span>
                        </div>
                        <div className="flex flex-col w-max">
                            <span className="text-[#585858] text-[16px]">End Date</span>
                            <span className="text-black text-lg font-semibold">
                                {department.departmentEndDate ? moment(department.departmentEndDate).format('DD/MM/YYYY') : 'Working'}
                            </span>
                        </div>
                        <div className="flex flex-col w-max">
                            <span className="text-[#585858] text-[16px]">Total Employees</span>
                            <span className="text-black text-lg font-semibold">
